...
export const navigationData: Day[] = [
  {
    ...
    exercises: [
      ...
      { id: "exercise-6", title: "Lab 2 · Optimistic Cache", type: "exercise" },
      { id: "exercise-7", title: "Lab 3 · Why Hey API", type: "exercise" },
      { id: "exercise-9", title: "Lab 4 · Generated Factories", type: "exercise" },
      { id: "exercise-11", title: "Lab 5 · Mutation + Zod", type: "exercise" },
      { id: "exercise-13", title: "Lab 6 · Pagination + Search", type: "exercise" },
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: "exercise-6", title: "Exercise 6 · Race-Free Optimistic", type: "exercise" },
    ],
  },
  {
    id: "8-hour",
