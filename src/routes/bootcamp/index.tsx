          ...
          <div className="grid gap-4 text-left md:grid-cols-2">
            ...
            >
              ...
              <p className="text-muted-foreground mt-2 text-sm">
                The compressed track: query options, optimistic cache discipline, Hey API adoption, generated factories,
                Zod mutations, pagination/search, and cache-race debugging.
              </p>
            </Link>
            <Link
              to="/bootcamp/challenge/$day/$exercise"
            ...
            >
              ...
              <p className="text-muted-foreground mt-2 text-sm">
                The full track with every lab: state/refetch UX, mutation lifecycle, invalidation, Suspense,
                prefetching, feature challenge, and capstone homework.
              </p>
            </Link>
          </div>
